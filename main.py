...
# وضعنا بياناتك هنا مباشرة لضمان الإقلاع السريع
API_ID = 20585941
API_HASH = "4c8b6debbee47ab644c82305487f34b2"
# السورس عيسحب الجلسة (Session) من ريندر تلقائياً
SESSION = os.environ.get("TERMUX_SESSION") or ""

client = TelegramClient(StringSession(SESSION), API_ID, API_HASH)

# --- [ إعدادات الوقت والخصوصية ] ---
...
async def mutamarrid_engine(event):
    ...
    # أمر التفليش (السحق الجماعي)
    elif cmd in [".تدمير", ".تفليش"]:
        await event.edit("**- جـاري الـتطهير والـسحق 🧨**")
...
# --- [ إقلاع السورس ] ---
print("🚀 الـمتمرد يـبدأ الإقـلاع بـاستخدام الـبيانات الـجديدة...")
with client:
    print("🦅 سـبر الـسورس يـا مـتمرد.. ادخل جرب الأوامر!")
